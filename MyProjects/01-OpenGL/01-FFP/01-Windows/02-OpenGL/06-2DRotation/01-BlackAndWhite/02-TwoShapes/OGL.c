...
GLfloat angleForTriangle = 0.0f;
GLfloat angleForRectangle = 0.0f;
...
void render(void)
{
	...
	glRotatef(angleForTriangle, 0.0f, 1.0f, 0.0f);
	...
	glRotatef(angleForRectangle, 1.0f, 0.0f, 0.0f);
...
{
	// code
	angleForTriangle = angleForTriangle + 0.05f;
	angleForRectangle = angleForRectangle + 0.05f;

	if (angleForTriangle >= 360.0f)
	{
		angleForTriangle = 0.0f;
	}

	if (angleForRectangle >= 360.0f)
	{
		angleForRectangle = 0.0f;
	}
}
