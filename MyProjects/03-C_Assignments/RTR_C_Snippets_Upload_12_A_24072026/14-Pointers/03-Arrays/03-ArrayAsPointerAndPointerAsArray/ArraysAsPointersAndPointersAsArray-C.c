...
int main(void)
{
    ...
    printf("*(SR_iArray + 1) = %d \t at address (SR_iArray + 1) : %p\n", *(SR_iArray + 1), (SR_iArray + 1));
    printf("*(SR_iArray + 2) = %d \t at address (SR_iArray + 2) : %p\n", *(SR_iArray + 2), (SR_iArray + 2));
    printf("*(SR_iArray + 3) = %d \t at address (SR_iArray + 3) : %p\n", *(SR_iArray + 3), (SR_iArray + 3));
    printf("*(SR_iArray + 4) = %d \t at address (SR_iArray + 4) : %p\n", *(SR_iArray + 4), (SR_iArray + 4));
    printf("*(SR_iArray + 5) = %d \t at address (SR_iArray + 5) : %p\n", *(SR_iArray + 5), (SR_iArray + 5));
    printf("*(SR_iArray + 6) = %d \t at address (SR_iArray + 6) : %p\n", *(SR_iArray + 6), (SR_iArray + 6));
    printf("*(SR_iArray + 7) = %d \t at address (SR_iArray + 7) : %p\n", *(SR_iArray + 7), (SR_iArray + 7));
    printf("*(SR_iArray + 8) = %d \t at address (SR_iArray + 8) : %p\n", *(SR_iArray + 8), (SR_iArray + 8));
    printf("*(SR_iArray + 9) = %d \t at address (SR_iArray + 9) : %p\n", *(SR_iArray + 9), (SR_iArray + 9));
