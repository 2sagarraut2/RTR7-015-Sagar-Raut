...
// sagar functions
void dhwajGhetlelaWarkari(GLfloat SR_XPosition, GLfloat SR_YPosition, GLfloat SR_Height, GLfloat SR_Width, GLfloat flagSway, GLfloat SR_percent);
void callDhwajGhetlelWarkari();
void drawFlower(GLfloat flowerRadius, GLfloat xPosition, GLfloat yPosition);
void calldrawFlower();
void drawTree(GLfloat SR_tree_xPosition, GLfloat SR_tree_yPosition, GLfloat SR_tree_width, GLfloat SR_tree_height, GLfloat SR_tree_thickness, GLfloat SR_tree_percent);
void drawClouds(GLfloat xPoint, GLfloat yPoint, GLfloat radius, GLfloat cloudPercent);
void cloudAnimation(GLfloat xCloudPosition);
// sagar name functions
void drawSagarName(GLfloat startingPointX, GLfloat startingPointY, GLfloat width, GLfloat thickness, GLfloat SR_namePercent);
void letterS(GLfloat startingPoint, GLfloat startingPointY, GLfloat width, GLfloat thickness, GLfloat SR_namePercent);
void letterA(GLfloat startingPointX, GLfloat startingPointY, GLfloat width, GLfloat thickness, GLfloat SR_namePercent);
void letterG(GLfloat startingPointX, GLfloat startingPointY, GLfloat width, GLfloat thickness, GLfloat SR_namePercent);
void letterR(GLfloat startingPointX, GLfloat startingPointY, GLfloat width, GLfloat thickness, GLfloat SR_namePercent);
void letterU(GLfloat startingPointX, GLfloat startingPointY, GLfloat width, GLfloat thickness, GLfloat SR_percent);
void letterI(GLfloat startingPointX, GLfloat startingPointY, GLfloat width, GLfloat thickness, GLfloat SR_percent);
void letterT(GLfloat startingPointX, GLfloat startingPointY, GLfloat width, GLfloat thickness, GLfloat SR_percent);
// anoushka tai name letters
void letterN(GLfloat startingPointX, GLfloat startingPointY, GLfloat width, GLfloat thickness, GLfloat SR_percent);
void letterO(GLfloat startingPointX, GLfloat startingPointY, GLfloat width, GLfloat thickness, GLfloat SR_percent);
void letterH(GLfloat startingPointX, GLfloat startingPointY, GLfloat width, GLfloat thickness, GLfloat SR_percent);
void letterK(GLfloat startingPointX, GLfloat startingPointY, GLfloat width, GLfloat thickness, GLfloat SR_percent);
void drawAnoushkaName(GLfloat startingPointX, GLfloat startingPointY, GLfloat width, GLfloat thickness, GLfloat SR_namePercent);

// project name functions
void SR_mukut(GLfloat psh_x_pos, GLfloat psh_y_pos, GLint psh_width_percentage, GLint psh_height_percentage);
void projectName(GLfloat SR_xPosition, GLfloat SR_yPosition, GLfloat SR_width, GLfloat SR_height, GLfloat SR_thickness, GLfloat SR_percent);

// pranali functions
void VitthalTimer(GLint value);
void psh_drawVitthal(GLfloat psh_x_pos, GLfloat psh_y_pos, GLint psh_width_percentage, GLint psh_height_percentage);
void psh_draw_ghoda(GLfloat psh_x_pos, GLfloat psh_y_pos, GLint psh_width_percentage, GLint psh_height_percentage);
void psh_draw_name(GLfloat psh_x_pos, GLfloat psh_y_pos);
void psh_draw_A(GLfloat psh_x_pos, GLfloat psh_y_pos);

// Hemant functions
void hbPalakhi(GLfloat hb_x, GLfloat hb_y, GLfloat hb_h, GLfloat hb_w);
void hbZumbar(GLfloat offset_x, GLfloat offset_y, GLfloat radius_x, GLfloat radius_y, GLfloat r, GLfloat g, GLfloat b, GLboolean drawLines);
void drawHemantName();
...
// harshal functions
void Tila(GLfloat psh_x_pos, GLfloat psh_y_pos, GLint psh_width_percentage, GLint psh_height_percentage);
void renderGroupPresents(GLfloat psh_x_pos, GLfloat psh_y_pos, GLint psh_width_percentage, GLint psh_height_percentage);
void drawHarshalName();

// shriniwas's funcions
void SJ_Chopdar(GLfloat suj_x, GLfloat suj_y, GLfloat suj_percent);
void shriniwasName();
void Rama(GLfloat suj_ramamam_x, GLfloat suj_ramamam_y, GLfloat suj_ramamam_percent);
void pradnya(GLfloat suj_pradnyamam_x, GLfloat suj_pradnyamam_y, GLfloat suj_pradnyamam_percent);
void gokhale(GLfloat suj_gokhale_x, GLfloat suj_gokhale_y, GLfloat suj_gokhale_percent);
void madam(GLfloat suj_madam_x, GLfloat suj_madam_y, GLfloat suj_madam_percent);
void under(GLfloat, GLfloat, GLfloat);
void guidance(GLfloat, GLfloat, GLfloat);
void our(GLfloat suj_our_x, GLfloat suj_our_y, GLfloat suj_our_percent);
void inspiration(GLfloat suj_inspiration_x, GLfloat suj_inspiration_y, GLfloat suj_inspiration_percent);

// Yogesh's functions
void drawQuad(GLfloat xP, GLfloat yP, GLfloat width, GLfloat height);
void drawHalfCircle(GLfloat cx, GLfloat cy, GLfloat r, GLint segments);
void drawCirlce(GLfloat cx, GLfloat cy, GLfloat r, GLint segment);
...
void drawPrasadName(GLfloat name_percent);
void drawSir(GLfloat SK_xPosition, GLfloat SK_yPosition, GLfloat percent, GLfloat SPK_xPosition, GLfloat SPK_yPosition, GLfloat SP_xPosition, GLfloat SP_yPosition);

// Astromedicomp functions
void AstroMediComp(GLfloat x_pos, GLfloat y_pos);

// anoushka vrindavan function
void drawTulshiVrindavan(GLfloat vXPosition, GLfloat vYPosition, GLfloat vPercent);

// fade in out functions
void ScreenFadeIn(GLint value);
void ScreenFadeOut(GLint value);
void ScreenQuad(void);

// GLOBAL VARIABLES
GLboolean bIsFullScreen = FALSE;
GLfloat xPosition = 0.0f;

// Warkari variable declarations - sagar
GLfloat SR_XPosition = -1.53f;
GLfloat SR_YPosition = 0.250f;
GLfloat SR_Height = 1.5f;
GLfloat SR_Width = 0.2f;
GLfloat SR_currentFlagWave = 0.0f;
GLboolean SR_bodyGoingUp = TRUE;
GLboolean SR_flagSwayingLeft = TRUE;
// sagar name variables
GLfloat startingPointX = -1.66f; // -0.9
GLfloat startingPointY = 0.30f;
GLfloat width = 0.32f;
GLfloat thickness = 0.10f;
GLfloat SR_namePercent = 55.0;
// cloud variable
GLfloat xCloudPosition = -2.5f;

// variables for project name - vaari
GLfloat SR_xPosition = -0.6f;
GLfloat SR_yPosition = 0.152f;
GLfloat SR_width = 1.2f;
GLfloat SR_height = 0.8f;
GLfloat SR_thickness = 0.11f;

// variables for tree
GLfloat SR_tree_xPosition = -1.3f;
GLfloat SR_tree_yPosition = 0.67f;
GLfloat SR_tree_width = 0.8f;
GLfloat SR_tree_height = 1.2f;
GLfloat SR_tree_thickness = 0.11f;
GLfloat SR_tree_percent = 50.0f;

// flower variable declarations - sagar
GLfloat SR_yForFlower = 0.95f;
GLfloat SR_xForFlower = 0.5f;

// sagar percentage
GLint SR_percent = 60.0f;

// pranali name variables
GLint psh_percent = 50;
...
GLfloat hb_h = 0.1f;
GLfloat hb_w = 0.1f;
GLfloat hb_percent = 50.0f;
// Colours
// Wood light colour
GLfloat woodlR = 0.58f;
GLfloat woodlG = 0.27f;
GLfloat woodlB = 0.13f;
// Wood dark colour
GLfloat wooddR = 0.86f;
GLfloat wooddG = 0.32f;
GLfloat wooddB = 0.2f;
// Golden colour
GLfloat goldR = 0.95f;
GLfloat goldG = 0.72f;
GLfloat goldB = 0.25f;
// lines colour
GLfloat lineR = 0.001f;
GLfloat lineG = 0.001f;
GLfloat lineB = 0.001f;
// hemant name variables
GLfloat x = 1.05f;
GLfloat y = 0.12f;
GLfloat hb_namePercent = 45.0f;
// lines colour
GLfloat nameLineR = 0.8f;
GLfloat nameLineG = 0.8f;
GLfloat nameLineB = 0.0f;
// 0.8f, 0.5f, 0.0f

// shriniwas variables
GLfloat suj_percent = 65.0f;
GLfloat suj_x = 0.6f;
GLfloat suj_y = -0.5f;
// shriniwas name variables
GLfloat suj_name_percent = 60.0f;
GLfloat suj_name_x = 0.0f;
GLfloat suj_name_y = -0.28f;
// rama madam name variables
GLfloat suj_ramamam_percent = 100.0f;
GLfloat suj_ramamam_x = 0.0f;
GLfloat suj_ramamam_y = 0.0f;
// pradnya madam name variables
GLfloat suj_pradnyamam_percent = 100.0f;
GLfloat suj_pradnyamam_x = 0.0f;
GLfloat suj_pradnyamam_y = 0.0f;
// madam word variables
GLfloat suj_madam_percent = 100.0f;
GLfloat suj_madam_x = 0.0f;
GLfloat suj_madam_y = 0.0f;
// gokhale word variables
GLfloat suj_gokhale_percent = 100.0f;
GLfloat suj_gokhale_x = 0.0f;
GLfloat suj_gokhale_y = 0.0f;

// yogesh name variables
// GLfloat YBG_shift_X = -0.5f;
// GLfloat YBG_shift_Y = -0.65f;
GLint YBG_percent = 75;
GLfloat YBG_shift_name_X = 0.62f;
GLfloat YBG_shift_name_Y = -0.12f;
GLint YBG_name_percent = 80;
// yogesh weena warkari variables
GLfloat YBG_shift_X = 0.87f;
GLfloat YBG_shift_Y = -0.65f;

// GLint YBG_percent = 100;

// prasad mandir variables
GLfloat PK_xPosition = 0.05f;
GLfloat PK_yPosition = 0.05f;
GLfloat PK_width;
GLfloat PK_height;
GLfloat percent = 110;
// prasad vijay gokhale name variables
GLfloat PS_xPosition;
GLfloat PS_yPosition = 0.0f;
GLfloat pr_name_percent = 100;
// prasad name variables
GLfloat PRASAD_xPosition = -0.5f;
GLfloat PRASAD_yPosition = 0.61f;

// Astromedicomp variables
GLfloat x_pos, y_pos;
GLfloat persent = 100.0f;

// harshal name variables
GLfloat har_percent = 40.0f;
GLfloat har_xPosition = 0.47f;
GLfloat har_yPosition = 0.76f;

// fade in out code
GLfloat ScreenFadeFactor = 1.0f; // Start fully black (faded in)
GLboolean ScreenFade = TRUE;
GLboolean FadeIn = TRUE, FadeOut = FALSE;

GLint scence = 0;
GLboolean astromedicompFIn = FALSE;
GLboolean astromedicompFOut = FALSE;

GLboolean bRenderGroupPresentsFIn = FALSE;
GLboolean bRenderGroupPresentsFOut = FALSE;

GLboolean bProjectNameFIn = FALSE;
GLboolean bProjectNameFOut = FALSE;

GLboolean showMainSceneFIn = FALSE;
GLboolean showMainSceneFOut = FALSE;

GLboolean bVitthalFIn = FALSE;
GLboolean bVitthalFout = FALSE;

GLboolean endCreditSceneIn = FALSE;
GLboolean endCreditSceneOut = TRUE;

GLboolean guidanceSceneFIn = FALSE;
GLboolean guidanceSceneFOut = TRUE;

GLboolean teamNamesFIn = FALSE;
GLboolean teamNamesFOut = TRUE;
...
{
	// function declarations
	GLint initialise(void); // to initialise things required for rendering
	...
	// Centering
	GLint SR_screenWidth = GetSystemMetrics(SM_CXSCREEN);  // x of screen - SM - SystemMetrics CX - count of x
	GLint SR_screenHeight = GetSystemMetrics(SM_CYSCREEN); // y of screen - CY - count of y
...
void calldrawFlower()
{
	...
	for (GLfloat xPos = -0.8f; xPos <= 0.8f; xPos = xPos + 0.08f)
	{
		GLint columnNumber = (col * 7) % 13;
		GLfloat baseY = SR_yForFlower + columnNumber * 0.15f;

		for (GLint row = 0; row < 12; row++)
		{
			GLfloat yPos = baseY + row * 0.2f;
...
void dhwajGhetlelaWarkari(GLfloat SR_XPosition, GLfloat SR_YPosition, GLfloat SR_Height, GLfloat SR_Width, GLfloat flagSway, GLfloat SR_percent)
{
	...
	GLfloat centerX = SR_VALUE_FROM_PERCENT((SR_XPosition + SR_Width / 2), SR_percent);
	GLfloat centerY = SR_VALUE_FROM_PERCENT((SR_YPosition - 0.35f), SR_percent);
	GLfloat radius = SCALE_RADIUS(0.048f, SR_percent);
	...
	GLfloat bukkaX = SR_VALUE_FROM_PERCENT((SR_XPosition + (SR_Width / 2)), SR_percent);
	GLfloat bukkaY = SR_VALUE_FROM_PERCENT((SR_YPosition - 0.37f), SR_percent);

	GLfloat radiusX = SCALE_RADIUS(0.015f, SR_percent);

	GLfloat radiusY = SCALE_RADIUS(0.015f + 0.011f, SR_percent);
	...
	//     GLfloat x = bukkaX + (cos(angle) * radiusX);
	//     GLfloat y = bukkaY + (sin(angle) * radiusY);
	...
	GLfloat earBukkaX = SR_VALUE_FROM_PERCENT((SR_XPosition + 0.045f), SR_percent);
	GLfloat earBukkaY = SR_VALUE_FROM_PERCENT((SR_YPosition - 0.31f), SR_percent);
	...
	for (GLint i = 0; i <= 360; i++)
	{
		...
		GLfloat x = earBukkaX + (cos(angle) * radiusX);
		GLfloat y = earBukkaY + (sin(angle) * radiusY);
...
void callDhwajGhetlelWarkari()
{
	GLfloat waveSpeed = 0.0012f;
	GLfloat maxFlagWidth = 0.035f;
...
void drawFlower(GLfloat radiusSize, GLfloat customX, GLfloat customY)
{
	glBegin(GL_TRIANGLE_FAN);

	GLfloat centerX = SR_VALUE_FROM_PERCENT(customX, SR_percent);
	GLfloat centerY = SR_VALUE_FROM_PERCENT(customY, SR_percent);
	glVertex2f(centerX, centerY);

	GLfloat baseRadius = SCALE_RADIUS(radiusSize, SR_percent);

	for (GLint i = 0; i <= 360; i++)
	{
		GLfloat angle = i * 3.14159f / 180.0f;
		GLfloat petalShapeModifier = 1.0f + 0.5f * cos(5.0f * angle);
		GLfloat x = centerX + (cos(angle) * baseRadius * petalShapeModifier);
		GLfloat y = centerY + (sin(angle) * baseRadius * petalShapeModifier);
		glVertex2f(x, y);
	}
	glEnd();
}
...
void psh_drawVitthal(GLfloat psh_x_pos, GLfloat psh_y_pos, GLint psh_width_percentage, GLint psh_height_percentage)
{
	...
	{
		GLfloat a = (180.0f + i) * 3.1415926f / 180.0f;

		GLfloat x = VALUE_FROM_PERCENT(0.08f * cos(a), psh_width_percentage);
		GLfloat y = VALUE_FROM_PERCENT(0.08f * sin(a), psh_height_percentage);
	...
	for (GLint i = 0; i <= 360; i++)
	{
		GLfloat a = (360.0f + i) * 3.1415926f / 180.0f;

		GLfloat x = VALUE_FROM_PERCENT(0.03f * cos(a), psh_width_percentage);
		GLfloat y = VALUE_FROM_PERCENT(0.035f * sin(a), psh_height_percentage);
...
void hbZumbar(GLfloat offset_x, GLfloat offset_y, GLfloat radius_x, GLfloat radius_y, GLfloat r, GLfloat g, GLfloat b, GLboolean drawLines)
{
	GLfloat x_center = percent_vaule((hb_x + offset_x), hb_percent);
	GLfloat y_center = percent_vaule((hb_y + offset_y), hb_percent);

	GLfloat rad_x = redius(radius_x, hb_percent);
	GLfloat rad_y = redius(radius_y, hb_percent);
	...
	{
		GLfloat angle = i * 3.14159f / 180.0f;
		GLfloat x = x_center + (cos(angle) * rad_x);
		GLfloat y = y_center + (sin(angle) * rad_y);
		glVertex2f(x, y);
	}
	glEnd();
	...
	if (drawLines)
	{
		...
		// lines
		GLfloat line_offsets[] = {0.06f, 0.04f, 0.02f, 0.00f, -0.02f, -0.04f, -0.06f};
		for (GLint i = 0; i < 7; i++)
		{
			GLfloat line_x = percent_vaule((hb_x + offset_x + line_offsets[i]), hb_percent);
			GLfloat line_y_top = percent_vaule((hb_y + offset_y), hb_percent);
			GLfloat line_y_bottom = percent_vaule((hb_y + offset_y - 0.05f), hb_percent);
...
void drawCirlce(GLfloat cx, GLfloat cy, GLfloat r, GLint segment)
{
	...
	{
		GLfloat theta = 2.0f * PI * i / segment;
...
void projectName(GLfloat SR_xPosition, GLfloat SR_yPosition, GLfloat SR_width, GLfloat SR_height, GLfloat SR_thickness, GLfloat SR_percent)
{
	...
	GLfloat centerX = SR_xPosition + 0.18f;
	GLfloat centerY = SR_yPosition - (SR_height / 2);
	GLfloat radius = SR_thickness * 2.5f;
	glVertex2f(centerX, centerY);
	...
	for (GLint i = 0; i <= 360; i++)
	{
		...
		GLfloat x = centerX + (cos(angle) * radius * 0.7f);
		GLfloat y = centerY + (sin(angle) * radius * 1.0f);
...
void drawTree(GLfloat SR_tree_xPosition, GLfloat SR_tree_yPosition, GLfloat SR_tree_width, GLfloat SR_tree_height, GLfloat SR_tree_thickness, GLfloat SR_tree_percent)
{
	...
	GLfloat centerX = SR_VALUE_FROM_PERCENT(SR_tree_xPosition, SR_tree_percent);
	GLfloat centerY = SR_VALUE_FROM_PERCENT(SR_tree_yPosition + 0.1f, SR_tree_percent);
	GLfloat radius = SCALE_RADIUS(SR_thickness * 3.0f, SR_tree_percent);
	glVertex2f(centerX, centerY);
	...
	for (GLint i = 0; i <= 360; i++)
	{
		...
		GLfloat x = centerX + (cos(angle) * radius * 0.8f);
		GLfloat y = centerY + (sin(angle) * radius * 1.0f);
...
void drawSagarName(GLfloat startingPointX, GLfloat startingPointY, GLfloat width, GLfloat thickness, GLfloat SR_namePercent)
{
	GLfloat originalStartingPointX = startingPointX;
...
void letterS(GLfloat startingPointX, GLfloat startingPointY, GLfloat width, GLfloat thickness, GLfloat SR_percent)
{
	glBegin(GL_QUADS);
...
void letterA(GLfloat startingPointX, GLfloat startingPointY, GLfloat width, GLfloat thickness, GLfloat SR_percent)
{
	glBegin(GL_QUADS);
...
void letterG(GLfloat startingPointX, GLfloat startingPointY, GLfloat width, GLfloat thickness, GLfloat SR_percent)
{
	glBegin(GL_QUADS);
...
void letterR(GLfloat startingPointX, GLfloat startingPointY, GLfloat width, GLfloat thickness, GLfloat SR_percent)
{
	glBegin(GL_QUADS);
...
void guidance(GLfloat suj_guidance_x, GLfloat suj_guidance_y, GLfloat suj_guidance_percent)
{
	// G
	glBegin(GL_QUADS);
	glColor3f(1.0f, 1.0f, 1.0f);
...
void under(GLfloat suj_under_x, GLfloat suj_under_y, GLfloat suj_under_percent)
{
	// U
	glBegin(GL_QUADS);
	glColor3f(1.0f, 1.0f, 1.0f);
...
void drawPrasadName(GLfloat name_percent)
{
	void prasadLetterA(GLfloat PRASAD_xPosition, GLfloat PRASAD_yPosition, GLfloat name_percent);
	// P
	glBegin(GL_QUADS);
	glColor3f(1.0f, 0.0f, 0.0f);
...
void drawClouds(GLfloat xPoint, GLfloat yPoint, GLfloat radius, GLfloat cloudPercent)
{
	...
	for (GLint i = 0; i <= 360; i++)
	{
		...
		GLfloat x = xPoint + (cos(angle) * radius);
		GLfloat y = yPoint + (sin(angle) * radius);
