...
GLvoid BuildFont(GLvoid) // Build Our Bitmap Font
{
	...
	font = CreateFont(-24,						   // Width Of Font
					  0,						   // Width Of Font
	...
	oldfont = (HFONT)SelectObject(SR_ghdc, font); // Selects The Font We Want
	wglUseFontBitmaps(SR_ghdc, 32, 96, base);	  // Builds 96 Characters Starting At Character 32
	SelectObject(SR_ghdc, oldfont);				  // Selects The Font We Want
